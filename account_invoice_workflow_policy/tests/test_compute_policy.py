...
class TestComputeInvoicePolicy(TransactionCase):
    ...
    def test_compute_case_1(self):
        ...
        invoice.journal_id.invoice_open_group_ids = [(
            6, 0, [
                self.grp_open.id
            ]
        )]

        invoice.journal_id.invoice_refund_group_ids = [(
            6, 0, [
                self.grp_refund.id
            ]
        )]

        invoice.journal_id.invoice_cancel_group_ids = [(
            6, 0, [
                self.grp_cancel.id
            ]
        )]
        ...
        self.assertEqual(
            True,
            invoice.sudo(
                self.user_1.id).restart_ok
        )
        self.assertEqual(
            True,
            invoice.sudo(
                self.user_1.id).reopen_ok
        )
        self.assertEqual(
            True,
            invoice.sudo(
    ...
    def test_compute_case_2(self):
        ...
        invoice.journal_id.invoice_reopen_group_ids = [(
            6, 0, [
                self.grp_re_open.id
            ]
        )]
        ...
        self.assertEqual(
            False,
            invoice.sudo(
                self.user_2.id).restart_ok
        )
        self.assertEqual(
            False,
            invoice.sudo(
                self.user_2.id).reopen_ok
        )
        self.assertEqual(
            True,
            invoice.sudo(
    ...
    def test_compute_case_3(self):
        ...
        invoice.journal_id.invoice_proforma_group_ids = [(
            6, 0, [
