...
class AccountDebtCollection(models.Model):
    ...
    def _prepare_criteria_move_line(self, voucher, collection_detail):
        ...
        commercial_partner_id =\
            voucher.partner_id.commercial_partner_id.id
        move_id =\
            collection_detail.invoice_id.move_id.id
    ...
    def _prepare_receipt_voucher_line_data(self, voucher, document):
        ...
        collection_detail =\
            document.collection_detail_id

        criteria_move_line =\
            self._prepare_criteria_move_line(
